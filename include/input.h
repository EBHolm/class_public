...
enum target_names {theta_s, theta_s_100, Omega_dcdmdr, omega_dcdmdr, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, z_decay_NEDE, Omega0_NEDE_trigger_DM, NEDE_trigger_ini, sigma8, S8};
